...
<div class="fields" style="text-align:center">您还没有配置 <b>TomatoAnon 项目</b>.
<br/>请到 <a href="admin-tomatoanon.asp">TomatoAnon 页面</a> 进行配置.</div>
<br/>
</div>

<div class="section-title">系统状态 <small><i><a href='javascript:toggleVisibility("system");'><span id="sesdiv_system_showhide">(hide)</span></a></i></small></div>
...
/* IPV6-BEGIN */
	{ title: 'LAN (br0) IPv6 地址', rid: 'ip6_lan', text: stats.ip6_lan, hidden: (stats.ip6_lan == '') },
	{ title: 'LAN (br0) IPv6 LL 地址', rid: 'ip6_lan_ll', text: stats.ip6_lan_ll, hidden: (stats.ip6_lan_ll == '') },
	{ title: 'LAN1 (br1) IPv6 地址', rid: 'ip6_lan1', text: stats.ip6_lan1, hidden: (stats.ip6_lan1 == '') },
	{ title: 'LAN1 (br1) IPv6 LL 地址', rid: 'ip6_lan1_ll', text: stats.ip6_lan1_ll, hidden: (stats.ip6_lan1_ll == '') },
	{ title: 'LAN2 (br2) IPv6 地址', rid: 'ip6_lan2', text: stats.ip6_lan2, hidden: (stats.ip6_lan2 == '') },
	{ title: 'LAN2 (br2) IPv6 LL 地址', rid: 'ip6_lan2_ll', text: stats.ip6_lan2_ll, hidden: (stats.ip6_lan2_ll == '') },
	{ title: 'LAN3 (br3) IPv6 地址', rid: 'ip6_lan3', text: stats.ip6_lan3, hidden: (stats.ip6_lan3 == '') },
	{ title: 'LAN3 (br3) IPv6 LL 地址', rid: 'ip6_lan3_ll', text: stats.ip6_lan3_ll, hidden: (stats.ip6_lan3_ll == '') },
/* IPV6-END */
...
/* REMOVE-END */
		...
		{ title: 'Broadcast', text: (nvram['wl'+u+'_closed'] == 0) ? '启用' : '<b>禁用<\/b>', ignore: (nvram['wl'+u+'_mode'] != 'ap') },
		{ title: '安全设置', text: sec },
