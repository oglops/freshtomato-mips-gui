...
<div class="section">
	...
	<div style="width: 100%; text-align: right"><input type="button" value="全部删除" onclick="deleteAll()" id="upnp-delete-all"> <input type="button" value="刷新" onclick="reloadPage();"></div>
</div>
