...
<ul>
	...
	</li><li><b>选择 IP 地址</b> - 例如: 1.2.3.4,1.1.0/24,1.2.3.1-1.2.3.4
	</li><li><b>所选端口</b> - 例如: 一个端口 (80), few ports (80,443,8888), 端口范围 (80:88), 混合 (80,8000:9000,9999)
	</li><li><b style="text-decoration:underline">警告!</b> - 如果你的路由器只有 32MB of RAM, 你必须使用交换分区.
</li></ul>
</div>
</form>
</div>
