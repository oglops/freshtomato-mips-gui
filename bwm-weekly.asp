...
<div id="rstats">
	...
	<div style="float:right;text-align:right">
		<b>显示方式</b> <select onchange="changeMode(this)" id="shmode"><option value="1" selected="selected">总和</option><option value="0">列表</option></select><br/>
		...
		<b>每周第一天</b> <select onchange="changeStart(this)" id="startwk"><option value="0" selected="selected">日</option><option value="1">一</option><option value="2">二</option><option value="3">三</option><option value="4">四</option><option value="5">五</option><option value="6">六</option></select><br/>
