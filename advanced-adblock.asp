...
<div class="section">
	<ul>
		<li><b>Adblock</b> - 自动更新将在每天凌晨 2:00-2.59 AM 启动</li>
		<li><b>调试模式</b> - 所有对 dnsmasq 的查询将被记录到系统日志</li>
		<li><b>黑名单 URL</b> - 正确的文件格式: 0.0.0.0 domain.com or 127.0.0.1 domain.com, 每行一个域名</li>
		<li><b>黑名单自定义</b> - 可选, 空格分隔: domain1.com domain2.com domain3.com</li>
		<li><b>白名单</b> - 可选, 空格分隔: domain1.com domain2.com domain3.com</li>
		<li><b style="text-decoration:underline">注意!</b> - 如果在Adblock中添加过多的黑名单可能会使路由器崩溃，因为可能会耗尽所有可用内存.</li>
	</ul>
</div>
